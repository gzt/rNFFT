...
nfct_2d <- function(x, f_hat){
    ...
    xvec = c(t(x))
    f_hatvec = c(f_hat)
    .Call("rnfct_2d", xvec, (f_hatvec), as.integer(M), as.integer(N0), as.integer(N1), PACKAGE="rNFFT")
}
...
ndct_2d <- function(x, f_hat){
    ...
    xvec = c(t(x))
    f_hatvec = c(f_hat)
    .Call("rndct_2d", xvec, (f_hatvec), as.integer(M), as.integer(N0), as.integer(N1), PACKAGE="rNFFT")
}
...
nfct_adjoint_2d <- function(x, f, N0, N1){
    ...
    fhat = .Call("rnfct_adjoint_2d", c(t(x)), (f), as.integer(M), as.integer(N0),as.integer(N1), PACKAGE="rNFFT")
...
ndct_adjoint_2d <- function(x, f, N0, N1){
    ...
    fhat = .Call("rndct_adjoint_2d", c(t(x)), (f), as.integer(M), as.integer(N0),as.integer(N1), PACKAGE="rNFFT")
    return(matrix(fhat, nrow=N0, byrow=TRUE))
}
...
nfst_2d <- function(x, f_hat){
    ...
    xvec = c(t(x))
    f_hatvec = c(f_hat)
    .Call("rnfst_2d", xvec, (f_hatvec), as.integer(M), as.integer(N0), as.integer(N1), PACKAGE="rNFFT")
}
...
ndst_2d <- function(x, f_hat){
    ...
    xvec = c(t(x))
    f_hatvec = c(f_hat)
    .Call("rndst_2d", xvec, (f_hatvec), as.integer(M), as.integer(N0), as.integer(N1), PACKAGE="rNFFT")
}
...
nfst_adjoint_2d <- function(x, f, N0, N1){
    ...
    fhat = .Call("rnfst_adjoint_2d", c(t(x)), (f), as.integer(M), as.integer(N0),as.integer(N1), PACKAGE="rNFFT")
...
ndst_adjoint_2d <- function(x, f, N0, N1){
    ...
    fhat = .Call("rndst_adjoint_2d", c(t(x)), (f), as.integer(M), as.integer(N0),as.integer(N1), PACKAGE="rNFFT")
    return(matrix(fhat, nrow=(N0-1), byrow=TRUE))
}
